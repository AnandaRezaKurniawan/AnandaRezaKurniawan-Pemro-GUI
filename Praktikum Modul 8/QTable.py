...
class MainForm(QWidget):
    def __init__(self):
        ...
        self.setupUi()
    def setupUi(self):
        ## set ukuran dan posisi form widget
        self.resize(700, 300)
        self.move(300, 300)
        ...
        ## konten widget
        self.table = QTableWidget()                 # membuat tabel baru
        self.table.setRowCount(5)                   # set baris sebanyak 5
        self.table.setColumnCount(3)                # set kolom sebanyak 3
    ...
    # menampilkan data yang dipilih ke line edit
    ...
    # menambahkan data yang sudah dideklarasikan ke dalam tabel
