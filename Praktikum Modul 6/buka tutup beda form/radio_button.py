...
## belajar RadioButton dan CheckBox
class MainForm(QWidget):
    def __init__(self):
        super().__init__()
        self.setupUi()

    # fungsi untuk membuat ui nya
    def setupUi(self):
        self.resize(400, 150)
        self.move(300, 300)
        self.setWindowTitle('Demo QRadioButton')

        # label dan lineEdit untuk bilangan
        self.label1 = QLabel()
        ...
        ## membuat radio button untuk masing-masing operasi bilangan
        self.addRadio = QRadioButton()
        self.addRadio.setText('&Tambah')
        self.addRadio.setChecked(True)      # True berarti dia sedang dipilih
        ...
        # kemudian dirapikan secara horizontal
        hbox = QHBoxLayout()
        ...
        # membuat label hasil
        self.resultLabel = QLabel('<b>Hasil penjumlahan: </b>')     # tag html bold
        self.calculateButton = QPushButton('Hitung')                # button hitung
        # merapikan semuanya secara vertical
        layout = QVBoxLayout()
        ...
        ## jika setiap radio diklik maka akan menghubungkan dengan
        ## teks dan fungsi masing-masing
        ...
        # menghubungkan button hitung dengan fungsi calculateButton()
        self.calculateButton.clicked.connect(self.calculateButtonClick)

    # fungsi melakukan perhitungan
